...
function openVehicleMenu(parts, plate, mileage, workshop) {
...
window.oncontextmenu = function (event) {
  ...
  if (element != null) {
    ...
    if (partType == "uninstalled") {
      ...
      html = html + '    <a onclick="changeToPatrol()">Inspect</a>';
    }
...
window.addEventListener('message', function (event) {
  ...
  if (edata.type == "open") {
    ...
    model = edata.model;
    openVehicleMenu(edata.parts, edata.plate, edata.mileage, edata.workshop);
